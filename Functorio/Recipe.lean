...
| .bigMiningDrill => {
  ...
  inputs := [(200, .moltenIron), (10, .advancedCircuit), (10, .electricEngineUnit), (20, .tungstenCarbide), (1, .electricMiningDrill)],
...
| .captiveBiterSpawner => {
  ...
  inputs := [(100, .fluoroketoneCold), (15, .uranium235), (10, .biterEgg), (1, .captureRobotRocket)],
...
| .coalSynthesis => {
  name := "coal-synthesis",
  inputs := [(10, .water), (1, .sulfur), (5, .carbon)],
  outputs := [(1, .coal)],
  category := .chemistry
  time := 2
}
...
| .concrete => {
  name := "concrete",
  inputs := [(100, .water), (1, .ironOre), (5, .stoneBrick)],
  outputs := [(10, .concrete)],
...
| .explosives => {
  name := "explosives",
  inputs := [(10, .water), (1, .coal), (1, .sulfur)],
...
| .expressSplitter => {
  ...
  inputs := [(80, .lubricant), (10, .ironGearWheel), (10, .advancedCircuit), (1, .fastSplitter)],
...
| .foundation => {
  name := "foundation",
  inputs := [(20, .fluoroketoneCold), (20, .stone), (4, .tungstenPlate), (4, .carbonFiber), (4, .lithiumPlate)],
...
| .foundry => {
  name := "foundry",
  inputs := [(20, .lubricant), (50, .steelPlate), (30, .electronicCircuit), (50, .tungstenCarbide), (20, .refinedConcrete)],
  outputs := [(1, .foundry)],
...
| .fusionPowerCell => {
  ...
  inputs := [(100, .ammonia), (1, .holmiumPlate), (5, .lithiumPlate)],
...
| .holmiumSolution => {
  ...
  inputs := [(10, .water), (1, .stone), (2, .holmiumOre)],
...
| .lightningCollector => {
  ...
  inputs := [(80, .electrolyte), (8, .supercapacitor), (1, .accumulator), (1, .lightningRod)],
...
| .overgrowthJellynutSoil => {
  ...
  inputs := [(100, .water), (5, .jellynutSeed), (50, .spoilage), (10, .biterEgg), (2, .artificialJellynutSoil)],
...
| .overgrowthYumakoSoil => {
  ...
  inputs := [(100, .water), (5, .yumakoSeed), (50, .spoilage), (10, .biterEgg), (2, .artificialYumakoSoil)],
...
| .pentapodEgg => {
  name := "pentapod-egg",
  inputs := [(60, .water), (30, .nutrients), (1, .pentapodEgg)],
...
| .quantumProcessor => {
  ...
  inputs := [(10, .fluoroketoneCold), (1, .processingUnit), (1, .tungstenCarbide), (1, .superconductor), (1, .carbonFiber), (2, .lithiumPlate)],
...
| .railgunTurret => {
  name := "railgun-turret",
  inputs := [(100, .fluoroketoneCold), (30, .tungstenPlate), (50, .superconductor), (20, .carbonFiber), (100, .quantumProcessor)],
...
| .refinedConcrete => {
  ...
  inputs := [(100, .water), (1, .steelPlate), (8, .ironStick), (20, .concrete)],
...
| .rocketFuelFromJelly => {
  ...
  inputs := [(30, .water), (2, .bioflux), (30, .jelly)],
  outputs := [(1, .rocketFuel)],
  category := .organic
  time := 10
}
...
| .supercapacitor => {
  name := "supercapacitor",
  inputs := [(10, .electrolyte), (1, .battery), (4, .electronicCircuit), (2, .holmiumPlate), (2, .superconductor)],
...
| .superconductor => {
  name := "superconductor",
  inputs := [(5, .lightOil), (1, .copperPlate), (1, .plasticBar), (1, .holmiumPlate)],
...
| .teslaAmmo => {
  name := "tesla-ammo",
  inputs := [(10, .electrolyte), (1, .plasticBar), (1, .supercapacitor)],
  outputs := [(1, .teslaAmmo)],
  category := .electromagnetics
  time := 30
}
...
| .teslaTurret => {
  name := "tesla-turret",
  inputs := [(500, .electrolyte), (10, .processingUnit), (50, .superconductor), (10, .supercapacitor), (1, .teslagun)],
...
| .teslagun => {
  name := "teslagun",
  inputs := [(100, .electrolyte), (30, .plasticBar), (10, .holmiumPlate), (10, .superconductor)],
  outputs := [(1, .teslagun)],
  category := .electromagnetics
  time := 30
}
...
| .tungstenCarbide => {
  ...
  inputs := [(10, .sulfuricAcid), (1, .carbon), (2, .tungstenOre)],
...
| .turboSplitter => {
  name := "turbo-splitter",
  inputs := [(80, .lubricant), (2, .processingUnit), (15, .tungstenPlate), (1, .expressSplitter)],
...
@[simp]
def speedup : Fabricator -> Fraction
| .assemblingMachine1 => 1/2
| .assemblingMachine2 => 3/4
| .assemblingMachine3 => 5/4
| .biochamber => 2
| .captiveBiterSpawner => 1
| .centrifuge => 1
| .character => 1
| .chemicalPlant => 1
| .crusher => 1
...
def handlesCategory : Fabricator -> RecipeCategory -> Bool
| .assemblingMachine1, .advancedCrafting => true
| .assemblingMachine1, .basicCrafting => true
| .assemblingMachine1, .crafting => true
| .assemblingMachine1, .electronics => true
| .assemblingMachine1, .parameters => true
| .assemblingMachine1, .pressing => true
| .assemblingMachine2, .advancedCrafting => true
| .assemblingMachine2, .basicCrafting => true
| .assemblingMachine2, .crafting => true
| .assemblingMachine2, .craftingWithFluid => true
| .assemblingMachine2, .craftingWithFluidOrMetallurgy => true
| .assemblingMachine2, .cryogenicsOrAssembling => true
| .assemblingMachine2, .electronics => true
| .assemblingMachine2, .electronicsOrAssembling => true
| .assemblingMachine2, .electronicsWithFluid => true
| .assemblingMachine2, .metallurgyOrAssembling => true
| .assemblingMachine2, .organicOrAssembling => true
| .assemblingMachine2, .organicOrHandCrafting => true
| .assemblingMachine2, .parameters => true
| .assemblingMachine2, .pressing => true
| .assemblingMachine3, .advancedCrafting => true
| .assemblingMachine3, .basicCrafting => true
| .assemblingMachine3, .crafting => true
| .assemblingMachine3, .craftingWithFluid => true
| .assemblingMachine3, .craftingWithFluidOrMetallurgy => true
| .assemblingMachine3, .cryogenicsOrAssembling => true
| .assemblingMachine3, .electronics => true
| .assemblingMachine3, .electronicsOrAssembling => true
| .assemblingMachine3, .electronicsWithFluid => true
| .assemblingMachine3, .metallurgyOrAssembling => true
| .assemblingMachine3, .organicOrAssembling => true
| .assemblingMachine3, .organicOrHandCrafting => true
| .assemblingMachine3, .parameters => true
| .assemblingMachine3, .pressing => true
| .biochamber, .organic => true
| .biochamber, .organicOrAssembling => true
| .biochamber, .organicOrChemistry => true
| .biochamber, .organicOrHandCrafting => true
| .biochamber, .parameters => true
| .captiveBiterSpawner, .captiveSpawnerProcess => true
| .captiveBiterSpawner, .parameters => true
| .centrifuge, .centrifuging => true
| .centrifuge, .parameters => true
| .character, .crafting => true
| .character, .electronics => true
| .character, .organicOrAssembling => true
| .character, .organicOrHandCrafting => true
| .character, .pressing => true
| .character, .recyclingOrHandCrafting => true
| .chemicalPlant, .chemistry => true
| .chemicalPlant, .chemistryOrCryogenics => true
| .chemicalPlant, .organicOrChemistry => true
| .chemicalPlant, .parameters => true
| .crusher, .crushing => true
| .crusher, .parameters => true
| .cryogenicPlant, .chemistryOrCryogenics => true
| .cryogenicPlant, .cryogenics => true
| .cryogenicPlant, .cryogenicsOrAssembling => true
| .cryogenicPlant, .parameters => true
| .electricFurnace, .smelting => true
| .electromagneticPlant, .electromagnetics => true
| .electromagneticPlant, .electronics => true
| .electromagneticPlant, .electronicsOrAssembling => true
| .electromagneticPlant, .electronicsWithFluid => true
| .electromagneticPlant, .parameters => true
| .foundry, .craftingWithFluidOrMetallurgy => true
| .foundry, .metallurgy => true
| .foundry, .metallurgyOrAssembling => true
| .foundry, .parameters => true
| .foundry, .pressing => true
| .oilRefinery, .oilProcessing => true
| .oilRefinery, .parameters => true
| .recycler, .recycling => true
| .recycler, .recyclingOrHandCrafting => true
| .rocketSilo, .parameters => true
| .rocketSilo, .rocketBuilding => true
| .steelFurnace, .smelting => true
| .stoneFurnace, .smelting => true
| _, _ => false
